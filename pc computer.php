<?php/* Template Name: ELECTRONIC DEVICES 1 pc computer*/  ?>
<?php get_header(); ?>
<title> pc computer</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 main-category">
                    <div class="row">
                        <div id="categoryContent" class="col-12 col-lg-3 mt-3">
                            ...
                            <div id="collapseCategory" class="collapse d-lg-block border"
                                ...
                                <ul class="show list-group list-group-flush">
                                    <ul class="show list-group list-group-flush">
                                        <li class="list-group-item "><a href="http://localhost:82/wordpress/index.php/electronic-devices-1-laptop/" class="nav-link">Laptop</a>
                                        </li>
                                        ...
                                        <li class="list-group-item active"><a href="http://localhost:82/wordpress/index.php/electronic-devices-1-pc-computer/"
                                                class="nav-link">PC Computer</a></li>
                        ...
                        <div class="col-12 col-lg-9 category-show product-content">
                            <h3 class="display-4 mx-3">PC Computer</h3>
                            <div class="row my-3">
                ...
                ?>
                   ...
                   <?php $eleimg_ca2t_pc=get_field('eleimg_cat22__pc');  ?>
                                ...
                                <div id="itemNewBook_1" class="item col-12 col-lg-6">
                                    <a href="#">
                                        <div class="row p-3">
                                            <div class="col-5">
                                                <img src="<?php echo $eleimg_ca2t_pc['url']; ?>" class="img-thumbnail" alt="">
                                            </div>
                                            <div class="col-7">
                                                <h4 class="text-dark"><?php the_field('ele_title_cat2_pc');  ?></h4>
                                                <p class="author text-dark"><?php the_field('ele_text_cat2_pc');  ?>
                                                </p>
                                                <div class="reason-set">
                                                    ...
                                                    <p class="product-price">
                                                        <span class="display-price"><?php the_field('ele_p_cat2_pc');  ?></span>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
