...
<?php/* Template Name: ELECTRONIC DEVICES 1 mobile_acc */  ?>

<?php get_header(); ?>
<title>mobile_acc</title>
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 main-category">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-9 category-show product-content">
                            <h3 class="display-4 mx-3">Mobile accessories</h3>
                            <div class="row my-3">
                ...
                ?>
                   ...
                   <?php $eleimg_ca2t_moac=get_field('eleimg_cat22__moac');  ?>
                                ...
                                <div id="itemNewBook_1" class="item col-12 col-lg-6">
                                    <a href="#">
                                        <div class="row p-3">
                                            <div class="col-5">
                                                <img src="<?php echo $eleimg_ca2t_moac['url']; ?>" class="img-thumbnail" alt="">
                                            </div>
                                            <div class="col-7">
                                                <h4 class="text-dark"><?php the_field('ele_title_cat2_moac');  ?></h4>
                                                <p class="author text-dark"><?php the_field('ele_text_cat2_moac');  ?>
                                                </p>
                                                <div class="reason-set">
                                                    ...
                                                    <p class="product-price">
                                                        <span class="display-price"><?php the_field('ele_p_cat2_moac');  ?></span>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
